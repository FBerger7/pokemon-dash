...
DOOR_CLOSED_TILE = os.path.join(PROJECT_ROOT, 'Assets/door_closed.png')
DOOR_OPEN_TILE = os.path.join(PROJECT_ROOT, 'Assets/door_open.png')
...
MUSIC_START_4_ASSET = os.path.join(PROJECT_ROOT, 'Music/start_4.mp3')
MUSIC_START_5_ASSET = os.path.join(PROJECT_ROOT, 'Music/start_5.mp3')
MUSIC_END_ASSET = os.path.join(PROJECT_ROOT, 'Music/ending.mp3')
MUSIC_VICTORY_ASSET = os.path.join(PROJECT_ROOT, 'Music/victory_music.mp3')
